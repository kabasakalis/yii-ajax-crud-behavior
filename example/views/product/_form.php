...
<div id="ajax-form" class='form'>
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'name', array('class' => 'span4', 'size' => 60, 'maxlength' => 128)); ?>
        ...
        <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->textField($model, 'price', array('class' => 'span4', 'size' => 60, 'maxlength' => 128)); ?>
                        <p class="help-block"><?php echo $form->error($model, 'price'); ?></p>
                    </div>
                </div>
